...
class ModelWrapper:
    ...
    def __init__(self, MLModule, MLModelFileStr, jobcomp):
        ...
        self.db_dump = sdbi.new_slurm_db(jobcomp)
...
def mlpd(jobcomp):
    ...
    model = ModelWrapper(MLModuleProxy(cfg.MLModule), cfg.MLModelFileStr, jobcomp)
